	        	...
	        	<table class="datatables table table-striped">
	        		<thead>
	        			<tr>
	        				...
	        				<th class="">Nama Desa/Kabupaten</th>
	        				<th class="">Nama Kecamatan</th>
	        				<th class="">Nama Kelurahan/Desa</th>
	        			</tr>
	        		</thead>
	        		<tbody>
	        			@foreach ($lists as $list)
	        				<tr>
	        					<td>{{ $list->kecamatan->kabupaten->provinsi->label }}</td>
	        					<td>{{ $list->kecamatan->kabupaten->label }}</td>
	        					<td>{{ $list->kecamatan->label }}</td>
	        					<td>
	        						{{ $list->label }}
